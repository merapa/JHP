    ...
    <jsp:useBean id="user" class="dao.MemberDAO" scope="page"/>
			...
			<div class="topnav">
				<div class="login-container">
					<form action="loginForm.jsp" method="post">
						...
						<button type="button" class="logoutbtn" onclick="location.href='logoutAction.jsp'" style="float: right;">Logout</button>
						<br><br><br><br>
